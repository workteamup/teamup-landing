...
const WhatCard = ({ title, text, img }) => {
  return (
    <div className="flex flex-col pt-16 w-full sm:w-[440px] bg-indigo-900 rounded-2xl hover:shadow-lg m-3 items-center">
      <h2 className="text-2xl font-semibold text-center mb-2 text-white">
        {title}
      </h2>

      <p className="text-base text-white/80 text-center mb-14">{text}</p>
