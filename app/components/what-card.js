...
const WhatCard = ({ title, text, img }) => {
  return (
    <div className="flex flex-col pt-16 w-full bg-blue-50 rounded-2xl items-center border border-blue-100 cursor-pointer hover:shadow-xl hover:border-200 group">
