...
const DailyActivityPage = () => {
  const dailyActivityData = {
    ...
    stats: [
      ...
      {
        value: "25%",
        description: "higher productivity and 40% better information retention in teams with engaging daily interactions"
      },
      {
        value: "$400B",
        description: "lost annually due to poorly run meetings in lost time and diminished engagement"
      }
    ],
    benefits: [
      {
  ...
  return <SolutionByTypePage typeData={dailyActivityData} />;
};
